...
void LCD_WriteBuff(uint16_t *DataBuff, uint16_t DataSize); // 批量写入数据到LCD
...
#define LCD_SPI                 SPI2
#define LCD_SPI_APBClock_Enable RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI2, ENABLE)

#define LCD_SCK_PIN             GPIO_Pin_13
#define LCD_SCK_PORT            GPIOB
#define GPIO_LCD_SCK_CLK        RCC_AHB1Periph_GPIOB
...
#define GPIO_LCD_SDA_CLK        RCC_AHB1Periph_GPIOB
...
#define GPIO_LCD_Backlight_CLK  RCC_AHB1Periph_GPIOA // 背光 GPIO时钟
